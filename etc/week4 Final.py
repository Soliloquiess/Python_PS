...
#         jumin = jumin1 + '-' + jumin2;
#         print(jumin);
#     if len(jumin) != 14 and len(jumin) != 13:
#         print(len(jumin));
#         print("잘못된 번호입니다")
#         return False
#     return True
...
#         century = jumin[6]  # 주민등록번호 뒷자리 시작번호
#         if century == '1' or century == '2':
#             birth_year += 1900
#         elif century == '3' or century == '4':
#             birth_year += 2000
...
#
# def main():
#     jumin = input("주민등록번호를 입력하세요 (XXXXXX-XXXXXXX): ")
#
#     if not validate_jumin(jumin):
#         return
#
...
#     main()
#
# # 위 경우 9412191823916 입력시 작동이 안됩니다 해당 문자열로 입력해도 정상작동하게 해주세요